...
public class CexConfig {
    ...
    public static final String depositCurrencyChain = "ETH";
    ...
    public static final String rechargeAddrUrl = "/app/cb/user/wallet/query/rechargeAddr";
    ...
    public static final String rechargeUrl = "/app/cb/user/record/query/recharge";
    ...
    public static final String withdrawInfoUrl = "/app/cb/user/withdraw/query/withdrawInfo";
    public static final String qwithdrawUrl = "/app/cb/user/record/query/withdraw";
    public static final String currencyChainInfoUrl = "/app/cb/currency/query/currencyChainInfo";
    ...
    public static final String dwithdrawAddressUrl = "/app/cb/user/withdraw/delete/withdrawAddress";
    public static final String addressUrl = "/app/cb/user/address/validate/address";
    public static final String loginorregisterUrl = "/app/userCenter/loginOrRegister";
    public static final String checkwithdrawaddressUrl = "/app/cb/user/withdraw/check/withdrawAddress";
    ...
    public static final String currencyListUrl = "/app/cb/currency/query/currencyList";
    ...
    public static final String submitwithdrawUrl = "/app/cb/user/withdraw/submit/withdraw";
