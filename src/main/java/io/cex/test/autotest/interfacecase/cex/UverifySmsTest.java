...
@Feature("verifySmsTest登录后发送手机验证码")
public class UverifySmsTest extends BaseCase {
    ...
    public void uverifySmsTestError(Map<?,?> param) throws IOException {
    ...
    public void uverifySmsTestError1() throws IOException {
        JSONObject object = new JSONObject();
        JSONObject jsonbody = new JSONObject();
        jsonbody.put("lang",lang);
        object.put("authType", "WITHDRAW_COIN");
        object.put("mobileArea", "86");
        object.put("mobile", "18780050294");
        jsonbody.put("data",object);
        Response response = OkHttpClientManager.post(ip + uverifySmsUrl, jsonbody.toJSONString(),
    ...
    public void uverifySmsTestError2() throws IOException {
        JSONObject object = new JSONObject();
        JSONObject jsonbody = new JSONObject();
        jsonbody.put("lang",lang);
    ...
    public void uverifySmsTest() throws IOException {
        JSONObject object = new JSONObject();
        JSONObject jsonbody = new JSONObject();
        jsonbody.put("lang",lang);
        object.put("authType", "WITHDRAW_COIN");
